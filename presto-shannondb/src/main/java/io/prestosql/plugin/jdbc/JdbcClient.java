...
public interface JdbcClient
{
    ...
    Optional<ShannonDBTableHandle> getTableHandle(JdbcIdentity identity, SchemaTableName schemaTableName);
    ...
    ConnectorSplitSource getSplits(JdbcIdentity identity, ShannonDBTableHandle tableHandle);
    ...
    PreparedStatement buildSql(ConnectorSession session, Connection connection, JdbcSplit split, ShannonDBTableHandle table, List<ShannonDBColumnHandle> columns)
            throws SQLException;
    ...
    void dropColumn(JdbcIdentity identity, ShannonDBTableHandle handle, ShannonDBColumnHandle column);

    void renameColumn(JdbcIdentity identity, ShannonDBTableHandle handle, ShannonDBColumnHandle jdbcColumn, String newColumnName);

    void renameTable(JdbcIdentity identity, ShannonDBTableHandle handle, SchemaTableName newTableName);
    ...
    void dropTable(JdbcIdentity identity, ShannonDBTableHandle shannonDBTableHandle);
