...
public final class StandardColumnMappings
{
    ...
    {
        return ColumnMapping.booleanMapping(BOOLEAN, ShannonDBPreparedStatement::getBoolean, booleanWriteFunction());
    }

    public static BooleanWriteFunction booleanWriteFunction()
    {
        return ShannonDBPreparedStatement::setBoolean;
    }

    public static ColumnMapping tinyintColumnMapping()
    {
        return ColumnMapping.longMapping(TINYINT, ShannonDBPreparedStatement::getByte, tinyintWriteFunction());
    }
    ...
    {
        return ColumnMapping.longMapping(SMALLINT, ShannonDBPreparedStatement::getShort, smallintWriteFunction());
    }
    ...
    {
        return ColumnMapping.longMapping(INTEGER, ShannonDBPreparedStatement::getInt, integerWriteFunction());
    }
    ...
    {
        return ColumnMapping.longMapping(BIGINT, ShannonDBPreparedStatement::getLong, bigintWriteFunction());
    }

    public static LongWriteFunction bigintWriteFunction()
    {
        return ShannonDBPreparedStatement::setLong;
    }
    ...
    {
        return ColumnMapping.doubleMapping(DOUBLE, ShannonDBPreparedStatement::getDouble, doubleWriteFunction());
    }

    public static DoubleWriteFunction doubleWriteFunction()
    {
        return ShannonDBPreparedStatement::setDouble;
    }
    ...
    public static Optional<ColumnMapping> jdbcTypeToPrestoType(ConnectorSession session, ShannonDBTypeHandle type)
    {
