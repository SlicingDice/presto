 ...
 */
package io.prestosql.plugin.xml;

import com.slicingdice.drivers.SlicingDiceXmlDriver;
        ...
        extends BaseJdbcClient
{
    ...
    @Inject
    public XmlClient(BaseJdbcConfig config, TypeManager typeManager)
            throws SQLException
    {
            ...
            throws SQLException
    {
        ...
        return new DriverConnectionFactory(new SlicingDiceXmlDriver(), config.getConnectionUrl(),
