...
import com.slicingdice.drivers.SlicingDiceOracleSalesDriver;
...
public class OracleSalesClient
        extends BaseJdbcClient
{
    protected final Type jsonType;

    @Inject
    public OracleSalesClient(BaseJdbcConfig config, TypeManager typeManager)
            throws SQLException
    {
            ...
            throws SQLException
    {
        ...
        return new DriverConnectionFactory(new SlicingDiceOracleSalesDriver(), config.getConnectionUrl(),
