...
import com.slicingdice.drivers.SlicingDiceGoogleDriveDriver;
        ...
        extends BaseJdbcClient
{
    ...
    @Inject
    public GoogleDriveClient(BaseJdbcConfig config, TypeManager typeManager)
            throws SQLException
    {
            ...
            throws SQLException
    {
        ...
        return new DriverConnectionFactory(new SlicingDiceGoogleDriveDriver(), config.getConnectionUrl(),
