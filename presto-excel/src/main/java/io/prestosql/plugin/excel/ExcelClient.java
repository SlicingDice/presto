 ...
 */
package io.prestosql.plugin.excel;

import com.slicingdice.drivers.SlicingDiceExcelDriver;
        ...
        extends BaseJdbcClient
{
    ...
    @Inject
    public ExcelClient(BaseJdbcConfig config, TypeManager typeManager)
            throws SQLException
    {
            ...
            throws SQLException
    {
        ...
        return new DriverConnectionFactory(new SlicingDiceExcelDriver(),
